...
<style>
    body{background:#eef0ff;font-family:'Segoe UI';padding:0;margin:0;}
    ...
    .card{background:#fff;padding:35px;border-radius:12px;box-shadow:0 10px 35px rgba(0,0,0,.08);}
    .qbox{background:#f8faff;border-radius:10px;padding:18px;margin-bottom:15px;border:1px solid #e0e5ff;}
    h3{font-size:17px;margin-bottom:10px;color:#4452ff;}
    .option{display:block;padding:10px;border-radius:8px;margin:6px 0;border:1px solid #cfd6ff;}
    .option:hover{background:#edf1ff;border-color:#6b75ff;}
    input[type=radio]{margin-right:8px;}
    .btn{width:100%;padding:15px;margin-top:18px;background:#6b75ff;color:#fff;font-size:18px;border:none;border-radius:8px;font-weight:bold;}
...
<p style="color:#666;margin-bottom:20px">Answer all questions below</p>

<% if(questions.isEmpty()){ %>

    <h3 style="color:red">No questions available in this category ❗</h3>
...
<div class="qbox">
    ...
    <label class="option"><input type="radio" name="q_<%=q.get("id")%>" value="A"> <%=q.get("A")%></label>
